...
class MyClassExample extends Component{
    ...
    getTime = () => {
        ...
        this.setState((state, props) => {
            /**
             * Pay attention to the callback parameters, in here we are passing the previews state and props
             */
            if (this.props.id === "1"){
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
         ...
         * We shouldn't call another interval here and it is wrong! The time interval is working, there is no need to close it!
